...
public class AvailableVehiclesDTO {
    ...
    // Remove @Autowired - DTOs are not Spring Beans
    private Customer c;
    private double distance;
    private String sourceLocation;
    private String destination;
    ...
    // Parameterized Constructor (Fixed distance type to double)
    ...
    public List<VehicleDetailsDTO> getAvailableVehicles() { return availableVehicles; }
    public void setAvailableVehicles(List<VehicleDetailsDTO> availableVehicles) { this.availableVehicles = availableVehicles; }

    @Override
    public String toString() {
        return "AvailableVehiclesDTO [customer=" + c.getName() + ", distance=" + distance + 
               ", source=" + sourceLocation + ", dest=" + destination + "]";
    }
}